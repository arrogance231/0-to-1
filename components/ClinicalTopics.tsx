    ...
    <div className='p-4 rounded-lg'>
      ...
      <div className='flex gap-2 overflow-x-auto sm:overflow-x-visible sm:flex-wrap'>
        {topics.map((topic, index) => (
          <div
            key={index}
            className='bg-[#EC5638] text-white px-3 py-2 rounded-lg flex items-center justify-center text-center font-semibold text-xs flex-1 cursor-pointer transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg active:scale-95 font-sans'
